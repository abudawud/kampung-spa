...
class ReferencePolicy
{
    ...
    const POLICY_NAME = "master.reference";
     ...
     * @return Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, Reference $model)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, Reference $model)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, Reference $model)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, Reference $model)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, Reference $model)
    {
