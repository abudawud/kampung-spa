...
class PackageItemPolicy
{
    ...
    const POLICY_NAME = "master.package-item";
     ...
     * @return Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, PackageItem $model)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function update(User $user, PackageItem $model)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, PackageItem $model)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function restore(User $user, PackageItem $model)
    {
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function forceDelete(User $user, PackageItem $model)
    {
