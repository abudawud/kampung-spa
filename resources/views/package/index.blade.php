                    ...
                    <div class="float-right">
                        <div class="btn-group">
                            @can(App\Policies\PackagePolicy::POLICY_NAME.".create")
                                <a id="btn-create" href="{{ route('package.create') }}" class="btn btn-primary modal-remote"> <span
    ...
    <script>
        $(document).ready(function() {
            ...
            const api = $('#datatable').DataTable({
              ...
              colReorder: true,
              order: [[0, 'desc']],
              columns: [{"data":"id"},{"data":"site_id"},{"data":"code"},{"data":"name"},{"data":"normal_price"},{"data":"member_price"},{"data":"description"},{"data":"launch_at"},{"data":"end_at"},{"data":"actions"}],
              columnDefs: [
