...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card mb-0">
                <h5 class="card-header bg-primary"><span class="fas fa-file-alt"></span> Data Registrasi Member</h5>
                <div class="card-body p-2">
                    <em>*Gunakan filter <b>Search</b> untuk pencarian global / filter perkolom pada bagian bawah</em>
                    <div class="float-right">
                        <div class="btn-group">
                            @can(App\Policies\CustomerRegistrationPolicy::POLICY_NAME . '.create')
                                <a id="btn-create" href="{{ route('customer-registration.create') }}"
    ...
    <x-alcrud-modal title="Registrasi Member" tableId="#datatable" />
@stop
    ...
    <script>
        $(document).ready(function() {
            ...
            const api = $('#datatable').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('customer-registration.index') }}",
                pageLength: 25,
                colReorder: true,
                order: [
                    [0, 'desc']
            ...
            $('#btn-export-excel').on('click', function(e) {
                ...
                downloadInNewTab("{{ route('customer-registration.export') }}" + "?type=excel&" + $.param(
                    params));
            });
        });
    </script>
