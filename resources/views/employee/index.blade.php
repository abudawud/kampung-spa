                    ...
                    <div class="float-right">
                        <div class="btn-group">
                            @can(App\Policies\EmployeePolicy::POLICY_NAME.".create")
                                <a id="btn-create" href="{{ route('employee.create') }}" class="btn btn-primary modal-remote"> <span
                    ...
                    <table width="100%" id="datatable" class="table table-sm table-hover">
                      <thead>
                        <tr>
                          ...
                          <th class="text-primary">Position Id</th>
                          <th class="text-primary">Nip</th>
                          <th class="text-primary">Name</th>
                          <th class="text-primary">Sex Id</th>
                      ...
                      <tfoot>
                        <tr class="filter">
                          ...
                          <th class="filter">Position Id</th>
                          <th class="filter">Nip</th>
                          <th class="filter">Name</th>
                          <th class="filter">Sex Id</th>
    ...
    <script>
        $(document).ready(function() {
            ...
            const api = $('#datatable').DataTable({
              ...
              colReorder: true,
              order: [[0, 'desc']],
              columns: [{"data":"id"},{"data":"site.city_name"},{"data":"position.name"},{"data":"nip"},{"data":"name"},{"data":"sex.name"},{"data":"dob"},{"data":"no_hp"},{"data":"height"},{"data":"weight"},{"data":"hire_at"},{"data":"address"},{"data":"is_active"},{"data":"actions"}],
              columnDefs: [
