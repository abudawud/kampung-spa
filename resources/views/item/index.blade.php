...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card mb-0">
                <h5 class="card-header bg-primary"><span class="fas fa-file-alt"></span> Data Master Treatment</h5>
                <div class="card-body p-2">
                    <em>*Gunakan filter <b>Search</b> untuk pencarian global / filter perkolom pada bagian bawah</em>
                    <div class="float-right">
                        <div class="btn-group">
                            @can(App\Policies\ItemPolicy::POLICY_NAME.".create")
                                <a id="btn-create" href="{{ route('item.create') }}" class="btn btn-primary modal-remote"> <span
    ...
    <x-alcrud-modal title="Master Treatment" tableId="#datatable" />
@stop
    ...
    <script>
        $(document).ready(function() {
            ...
            const api = $('#datatable').DataTable({
              ...
              colReorder: true,
              order: [[0, 'desc']],
              columns: [{"data":"id"},{"data":"site.city_name"},{"data":"code"},{"data":"name"},{"data":"duration"},{"data":"normal_price"},{"data":"member_price"},{"data":"description"},{"data":"is_active"},{"data":"actions"}],
              columnDefs: [
